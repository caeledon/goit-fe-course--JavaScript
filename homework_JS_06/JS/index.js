...
class Hamburger {
    ...
    */
    ...
    removeTopping(topping) {
        if(this._toppings.includes(topping)){
            ...
            // this._topping.filter(el => el !== topping);
        }
    }
    ...
    get calculatePrice (){
        return (
            ...
            this._toppings.reduce (
                (acc, topping) => Hamburger.TOPPINGS[topping].price + acc, 0
            )
        )
    }
    ...
    get calculateCalories (){
        return (
            ...
            this._toppings.reduce (
                (acc, calories) => Hamburger.TOPPINGS[calories].calories + acc, 0
            )
        )
    }
  }
  ...
  */
  ...
  console.log("Calories: ", hamburger.calculateCalories);//Calories: 70
  
  // Сколько стоит?
  console.log("Price: ", hamburger.calculatePrice);//Price:  55
  
  // Я тут передумал и решил добавить еще соус
  hamburger.addTopping(Hamburger.TOPPING_SAUCE);
  
  // А сколько теперь стоит?
  console.log("Price with sauce: ", hamburger.calculatePrice);//Price with sauce:  70
  
  // Проверить, большой ли гамбургер?
  console.log("Is hamburger large: ", hamburger.size === Hamburger.SIZE_LARGE); // Is hamburger large:  false
  
  // Убрать добавку
  hamburger.removeTopping(Hamburger.TOPPING_SPICE);
  
  // Смотрим сколько добавок
  console.log("Hamburger has %d toppings", hamburger.toppings.length); // Hamburger has 1 toppings
